...
import com.cgfay.eglnativerender.utils.TextureRotationUtils;
...
public class BaseImageFilter {
    ...
    protected FloatBuffer mVertexBuffer = FULL_RECTANGLE_BUF;
    protected FloatBuffer mTextureBuffer = GlUtil.createFloatBuffer(TextureRotationUtils.TextureVertices);
    ...
    public BaseImageFilter(Context context, String vertexShader, String fragmentShader) {
        mContext = context;
     ...
     * @return
     */
    public int getCurrentFrameBufferTexture() {
        if (mFramebuffers == null) {
            return -1;
        }
        return mFramebufferTextures[0];
